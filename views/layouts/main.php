...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="aviso-privacidad-colum">
                     ...
                     <span class="aceptar-terminos-condiciones-btn"> He leído aviso de privacidad </span>
        ...
        <div id="modal-terminos-condiciones" class="modal modal-terminos-condiciones">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <span class="close modal-terminos-condiciones-close" id="modal-terminos-condiciones-close">×</span>
